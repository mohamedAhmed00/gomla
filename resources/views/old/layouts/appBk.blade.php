...
<head>
    ...
    <link rel="stylesheet" href="{{url('/public/')}}/css/bootstrap-rtl.css">
    <link rel="shortcut icon" href="{{url('/public/gomla/')}}/images/favicon.ico" type="image/x-icon">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('/public/gomla/')}}/images/favicon-32x32.png">

    <link rel="icon" type="image/png" sizes="16x16" href="{{url('/public/gomla/')}}/images/favicon-16x16.png">
    <link rel="icon" href="{{url('/public/gomla/')}}/images/favicon.ico" type="image/x-icon">
    ...
    <header>
        <div class="header-banner">
            <div class="assetBlock">
                <div style="height: 20px; overflow: hidden;" id="slideshow">
                    ...
                    <p style="font-size: 16px;   font-weight: 600; display: none;"> وفر فلوسك .. وفر وقتك .. وفر مجهودك </p>
        ...
        <div id="header">
            <div class="header-container container">
                <div class="row">
                    <div class="logo"><a href="{{url('/')}}" title="gomla">
                            <div><img src="{{url('/public/gomla/')}}/images/logo.png" alt="{{ config('app.name') }}">
                            </div>
                        </a></div>
                        ...
                        <nav>
                            ...
                            <div class="nav-inner">
                                ...
                                <ul id="nav" class="hidden-xs">
                                    ...
                                    <li class="mega-menu"><a class="level-top" href="{{url('/categories')}}"><span>الأقسام</span></a>
                                                    ...
                                                    <div class="col-2">
                                                        <div class="menu_image">
                                                            <a title="الاقسام" href="{{url('categories')}}">
                                                                <img alt="menu_image"
                                                                     src="{{url('/public/gomla/')}}/images/Categories-Menu.png">
                                                            </a>
                                                        </div>
                                ...
                                <div class="fl-nav-links">
                                    ...
                                    <ul class="links">
                                        @if(session('auth_token'))
                                            ...
                                            <li class="last">
                                                <a href="{{url('logout')}}" title="Login"><span>الخروج</span></a>
                                            </li>

                                        @else
                                            <li class="last">
                                                <a href="{{url('login')}}" title="Login"><span>تسجيل الدخول</span></a>
                                            <li class="last">
                                                <a href="{{url('register')}}" title="Login"><span>حساب جديد</span></a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                            ...
                            <div class="mini-cart">
                                ...
                                <div class="fl-mini-cart-content" style="display: none;">
                                    <div class="block-subtitle">
                                        <div id="countapp" class="top-subtotal">{{count( (session('cart')) )}} في سلة
                                            الشراء
                                            <span
                                                    ...
                                                    <div class="item-inner">
                                                        <a class="product-image" title="{{$product->name}}"
                                                           href="{{url('product/'.$product->id)}}">
                                                            ...
                                                            @else
                                                                <img alt="{{$product->name}}"
                                                                     src="{{url('/public/gomla/')}}/products-images/product-img.jpg">
                                                            @endif
                                                        </a>
                        ...
                        <div class="collapse navbar-collapse">
                            ...
                            <form action="{{url('/search')}}" id="formsearch" method="GET" class="navbar-form"
                                ...
                                <div class="input-group">
                                    <input type="text" name="product" id="inputsearch" class="form-control"
                                           placeholder="Search">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col">
                            ...
                            <div class="payment-accept">
                                <div>
                                    <img src="{{url('/public/gomla/')}}/images/Payment-Card-on-delivery.png"
                                         alt="الدفع ببظاقه الإتمان">
                                    <img src="{{url('/public/gomla/')}}/images/Payment-Card-online.png"
                                         alt="الدفع اونلاين">
                                    <img src="{{url('/public/gomla/')}}/images/Payment-Cash-icon.png" alt="الدفع نقداً">
                                </div>
                            </div>
                        </div>
                        <!-- Footer Newsletter -->
                ...
                <div class="row">
                    <div style="float: left" class="col-sm-4 col-xs-12 col-lg-4">
                        <div class="co-info">
                            <div>
                                <a href="{{url('/')}}">
                                    <img src="{{url('/public/gomla/')}}/images/logo.png" alt="footer logo">
                                </a>
                            </div>
                            <address>
                                {{--<div>--}}
                                ...
                                <ul class="link">
                                    <li class="fb pull-left">
                                        <a target="_blank" rel="nofollow"
                                           href="https://www.facebook.com/GomlaOnline.eg/" title="Facebook"></a>
                                    </li>
    ...
    jQuery(document).ready(function () {
     ...
     jQuery('#inputsearch').on('keyup',function(){
        ...
        jQuery('#inputsearch').autocomplete({
            ...
            // serviceUrl:"http://admin.gomla.online/api/search/products?autocomplete=true&name="+searchtag+""
        });
     });
</script>
<script type="text/javascript">
