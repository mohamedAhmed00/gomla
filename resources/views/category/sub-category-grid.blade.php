...
<!-- BREADCRUMBS SETCTION START -->
    <div class="breadcrumbs-section plr-200 mb-80">
        <div class="breadcrumbs overlay-bg" style="background: #f6f6f6 url('http://163.172.33.245/goomla/storage/app/erpnext/{{$catimg['images'][0]}}') no-repeat scroll center center;background-size: 100% 100%;height: 500px">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="breadcrumbs-inner">
                            <h1 class="breadcrumbs-title" style="color:#000;padding-top: 215px;font-family: 'Amiri', serif">{{ $catimg['name'] }}</h1>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="product-item">
                                                    ...
                                                    <div class="product-info">
                                                        <h6 class="product-title"><a href="{{url('products/'.$category['id'])}}" title="{{$category['name']}}">{{$category['name']}}</a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
